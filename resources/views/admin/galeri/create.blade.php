...
@section('content')
    <div class="container py-10 flex justify-center">
        <div class="max-w-lg w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            @endif
            <div class="p-6">
                <h4 class="text-2xl font-semibold text-blue-gray-900 mb-1">Tambah Galeri</h4>
                <p class="text-base text-gray-700 mb-4">buatkan Galeri</p>
                <form action="{{ route('galeri.store') }}" class="w-full" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Foto / Video</label>
                        <input name="image" id="image" type="file" accept="image/* ,video/*"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"></textarea>
                    </div>
                    <button type="submit"
