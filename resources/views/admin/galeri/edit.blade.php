    ...
    <div class="container py-10 flex justify-center">
        <div class="max-w-lg w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <form method="POST" action="{{ route('galeri.update', $data->id) }}" class="w-full"
                    ...
                    <div class="mb-4">
                        ...
                        @if ($data->image_url)
                            @if ($data->fileType == 'image')
                                <input type="hidden" name="image_lama" value="{{ $data->image_url }}">
                                <img src="{{ asset($data->image_url) }}" width="70" height="70" alt="Foto Sebelumnya">
                            @else
                                
                                <input type="hidden" name="image_lama" value="{{ $data->image_url }}">
                                <video src="{{asset($data->image_url)}}" width="70" height="70"></video>
