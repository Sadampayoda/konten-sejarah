...
{{-- @dd($id) --}}
    <div class="container py-10">
        <div class="max-w-md mx-auto bg-white rounded-lg overflow-hidden shadow-md">
            <div class="p-10">
                <h2 class="text-2xl font-semibold mb-4 text-center">Edit Data Keahlian</h2>
                @if ($errors->any())
                ...
                <form action="{{ route('keahlian.update',$data->id) }}" method="POST" >
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative h-11 w-full min-w-[200px]">
                            <input type="text" value="{{$data->nama_keahlian}}" name="nama_keahlian" id="nama_keahlian" placeholder="Nama keahlian"
