...
@section('content')
    <div class="container py-10 flex justify-center">
        <div class="max-w-lg w-full bg-white shadow-md rounded-lg overflow-hidden">
            ...
            @endif
            <div class="p-6">
                <h4 class="text-2xl font-semibold text-blue-gray-900 mb-1">Tambah Sosial Media</h4>
                <p class="text-base text-gray-700 mb-4">buatkan Sosial Media</p>
                <form action="{{ route('medsos.store') }}" class="w-full" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
